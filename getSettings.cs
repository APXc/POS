...
namespace Pos_PointOfSales
{
    ...
    class getSettings
    {
        ...
        private void DataBaseTest()
        {
            ...
            string TestRecepit = "IF OBJECT_ID(N'dbo.Recepit', N'U') IS NULL BEGIN  CREATE TABLE Recepit([Id] [bigint] IDENTITY(1,1) NOT NULL, [dateTime] [DateTime] NOT NULL, CostumerID bigint NOT NULL, count decimal not null, DiscountID bigint NOT NULL,  PaymentID bigint NOT NULL); END;";
            string TestRecepitRow = "IF OBJECT_ID(N'dbo.RecepitRow', N'U') IS NULL BEGIN  CREATE TABLE RecepitRow([Id] [bigint] IDENTITY(1,1) NOT NULL, FatherID bigint NOT NULL, qta int not null, value decimal not null,valueToTax decimal, articleID bigint NOT NULL,  invectoryID bigint NOT NULL); END;";
            TestOnDB(TestUser);
